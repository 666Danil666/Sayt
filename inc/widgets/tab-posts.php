...
if ( !function_exists('blog_prime_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function blog_prime_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Blog_Prime_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'blog_prime_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Blog_Prime_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Blog_Prime_Tab_Posts_Widget extends Blog_Prime_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'blog_prime_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'blog-prime'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'blog-prime'),
                    'type'           => 'heading',
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'blog-prime'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'blog-prime'),
                    'type'              => 'checkbox',
                    'default'           => true,
                ),
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'blog-prime'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'blog-prime'),
                        'medium' => esc_html__( 'Medium', 'blog-prime' ),
                        'large' => esc_html__( 'Large', 'blog-prime' ),
                        'full' => esc_html__( 'Full', 'blog-prime' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'blog-prime'),
                    'description'   => esc_html__('Number of words', 'blog-prime'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'blog-prime'),
                    'type'          => 'heading',
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'blog-prime'),
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'blog-prime'),
                    'type'            => 'heading',
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'blog-prime'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'blog-prime-tabbed', esc_html__( 'BP: Tab Posts Widget', 'blog-prime' ), $opts, array(), $fields );
                    ...
                    <ul class="twp-nav-tabs" >
                        <li id="tab-popular" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e( 'Popular', 'blog-prime' );?>
                            </a>
                        </li>
                        <li id="tab-recent" class="tab tab-recent">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e('Recent', 'blog-prime');?>
                            </a>
                        </li>
                        <li id="tab-comments" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e('Comments', 'blog-prime');?>
                            </a>
                        </li>
                    </ul>
                </div>
